      ...
      <DialogContent className="mx-4 max-h-[calc(100dvh-1rem)] w-[calc(100vw-2rem)] max-w-sm overflow-y-auto border border-slate-700 bg-slate-900 text-white shadow-2xl">
        ...
        <DialogFooter>
          <Button
            ...
            className="min-h-11 w-full bg-avs-yellow text-base font-bold text-slate-950 shadow-sm hover:bg-avs-yellow-hover disabled:bg-avs-yellow disabled:text-slate-950 disabled:opacity-70"
          >
            Done
          </Button>
        </DialogFooter>
