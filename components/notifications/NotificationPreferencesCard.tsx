              ...
              >
                ...
                <div className="grid grid-cols-2 gap-3 sm:gap-2">
                  <button
                    ...
                    className={`flex min-h-24 flex-col items-center justify-center gap-2 rounded-xl border px-3 py-3 text-center transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-avs-yellow disabled:cursor-not-allowed disabled:opacity-60 sm:min-h-20 ${channelButtonClassName(preference.notify_in_app, 'in-app')}`}
                  >
                  ...
                  <button
                    ...
                    className={`flex min-h-24 flex-col items-center justify-center gap-2 rounded-xl border px-3 py-3 text-center transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-avs-yellow disabled:cursor-not-allowed disabled:opacity-60 sm:min-h-20 ${channelButtonClassName(preference.notify_email, 'email')}`}
                  >
