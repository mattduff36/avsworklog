...
const ALERT_DIALOG_SAFE_VIEWPORT_STYLE: React.CSSProperties = {
...
>(({ className, style, ...props }, ref) => (
  <AlertDialogPortal>
    ...
    <AlertDialogPrimitive.Content
      ...
      className={cn(
        "fixed left-[50%] top-[50%] z-[200] grid max-h-[calc(100dvh-1rem)] w-[calc(100vw-1rem)] max-w-lg translate-x-[-50%] translate-y-[-50%] gap-6 overflow-y-auto overscroll-contain border-0 bg-slate-900 p-6 shadow-2xl duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[state=closed]:slide-out-to-left-1/2 data-[state=closed]:slide-out-to-top-[48%] data-[state=open]:slide-in-from-left-1/2 data-[state=open]:slide-in-from-top-[48%] sm:rounded-xl",
        className
      )}
      style={{ ...ALERT_DIALOG_SAFE_VIEWPORT_STYLE, ...style }}
      {...props}
    />
  </AlertDialogPortal>
))
...
const AlertDialogHeader = ({
  ...
  <div
    className={cn(
      "flex flex-col space-y-2 text-center sm:text-left pb-0",
      className
    )}
    {...props}
  />
...
const AlertDialogFooter = ({
  ...
  <div
    className={cn(
      "flex flex-col-reverse gap-2 sm:flex-row sm:flex-wrap sm:justify-end pt-0",
      className
    )}
    {...props}
  />
