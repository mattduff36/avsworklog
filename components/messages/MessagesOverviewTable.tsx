...
const TYPE_BADGE_CONFIG: Record<MessageType, { label: string; className: string; variant?: 'destructive' }> = {
  ...
  NOTIFICATION: {
    label: 'Notification',
    className: 'whitespace-nowrap bg-avs-yellow text-slate-900 hover:bg-avs-yellow-hover',
  },
  REMINDER: {
    label: 'Reminder',
                  ...
                  {message.message.type === 'TOOLBOX_TALK' ? (
                    <>
                      ...
                      <Button
                        ...
                        className="h-8 w-8 bg-avs-yellow p-0 text-slate-900 hover:bg-avs-yellow-hover"
                        title="Export PDF"
