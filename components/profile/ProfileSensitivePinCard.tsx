...
export function ProfileSensitivePinCard() {
  ...
  const pinInputClassName =
    'h-14 border-slate-500/80 bg-slate-950/70 text-center text-xl tracking-[0.35em] text-foreground shadow-inner shadow-black/20 placeholder:tracking-normal placeholder:text-slate-500 focus-visible:border-avs-yellow focus-visible:ring-avs-yellow/60 sm:h-10 sm:text-sm sm:tracking-normal';
  ...
  return (
    <Card className="relative overflow-hidden border-slate-700/70 bg-slate-950/95 shadow-2xl shadow-black/30">
      ...
      <div className="pointer-events-none absolute inset-x-10 top-0 h-px bg-gradient-to-r from-transparent via-avs-yellow/80 to-transparent" />
      <CardHeader className="relative">
        <div className="flex flex-col items-center gap-3 text-center sm:flex-row sm:items-start sm:text-left">
          <div className="flex h-14 w-14 items-center justify-center rounded-2xl border border-avs-yellow/35 bg-avs-yellow/15 text-avs-yellow shadow-lg shadow-avs-yellow/10 sm:h-10 sm:w-10 sm:rounded-lg">
