            ...
            <div className="grid gap-3 lg:grid-cols-2">
              {modules.map((module) => {
                ...
                <Link
                  ...
                  href={href}
                  className={`block rounded-xl border p-4 shadow-sm transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-avs-yellow focus-visible:ring-offset-2 focus-visible:ring-offset-slate-950 ${tileClasses.card} ${tileClasses.cardHover}`}
                >
                  <div className="flex gap-3">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      {module.requires_sensitive_pin ? (
                        <Badge variant="outline" className="mt-3 border-avs-yellow/50 bg-avs-yellow/10 px-2.5 py-1 text-sm text-avs-yellow sm:px-2 sm:py-0.5 sm:text-xs">
