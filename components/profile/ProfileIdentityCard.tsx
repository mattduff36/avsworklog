            ...
            <div className="grid min-w-0 grid-cols-2 items-center gap-3 sm:flex sm:gap-4">
              <Dialog open={isAvatarDialogOpen} onOpenChange={setIsAvatarDialogOpen}>
                <DialogTrigger asChild>
                  <button
                    type="button"
                    className="relative aspect-square w-full max-w-[7rem] shrink-0 justify-self-center rounded-full focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-avs-yellow focus-visible:ring-offset-2 focus-visible:ring-offset-slate-950 disabled:cursor-not-allowed disabled:opacity-60 sm:h-24 sm:w-24 sm:max-w-none sm:justify-self-auto"
                  ...
                  >
                    <span className="relative block h-full w-full overflow-hidden rounded-full border border-border bg-slate-900/30">
                      {profile.avatar_url ? (
                        ...
                        <span className="flex h-full w-full items-center justify-center bg-slate-800 text-xl font-semibold text-avs-yellow sm:text-2xl">
                          {initials}
                        </span>
                      )}
                    </span>

                    <span className="absolute -bottom-0.5 -right-0.5 z-10 flex h-8 w-8 items-center justify-center rounded-full border border-slate-950 bg-avs-yellow text-slate-950 shadow-lg transition hover:bg-avs-yellow/90 sm:h-8 sm:w-8">
