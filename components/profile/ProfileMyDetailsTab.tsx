...
const profileInputClassName =
  'h-14 border-slate-500/80 bg-slate-950/70 text-lg text-foreground shadow-inner shadow-black/20 placeholder:text-slate-500 focus-visible:border-avs-yellow focus-visible:ring-avs-yellow/60 read-only:bg-slate-800/60 read-only:text-slate-300 sm:h-10 sm:text-sm';

const profileTextareaClassName =
  'min-h-32 border-slate-500/80 bg-slate-950/70 text-lg text-foreground shadow-inner shadow-black/20 placeholder:text-slate-500 focus-visible:border-avs-yellow focus-visible:ring-avs-yellow/60 sm:min-h-20 sm:text-sm';
  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-6">
        ...
        <section className="space-y-4 rounded-xl border border-[hsl(var(--avs-yellow)/0.45)] bg-[hsl(var(--avs-yellow)/0.08)] p-5 shadow-inner shadow-black/10 sm:rounded-lg sm:border-[hsl(var(--avs-yellow)/0.3)] sm:bg-[hsl(var(--avs-yellow)/0.06)] sm:p-4">
          <div>
        ...
        <Button
          ...
          className="h-14 w-full bg-avs-yellow text-base font-semibold text-slate-900 hover:bg-[#d1b82f] disabled:opacity-60 sm:h-9 sm:w-auto sm:text-sm"
        >
          {isSaving ? (
            <>
