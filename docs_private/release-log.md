...
**GIT COMMIT MESSAGE**
`feat(workshop-tasks): update Workshop Tasks and Actions`

**PUSHED AT**
2026-09-07T18:08:46.509Z

**WHAT CHANGED**
Update Workshop Tasks and Actions.

**VERSION HISTORY DETAILS**
- Updated Workshop Tasks and Actions, with changes to app screens, interface components, shared logic, and automated tests.
...
**PUSHED AT**
2026-08-04T16:12:01.039Z

**WHAT CHANGED**
Update Release automation and App reliability.

**VERSION HISTORY DETAILS**
- Updated Release automation and App reliability, with changes to automation scripts.
- Updated app reliability, with changes to automated tests.
...
**GIT COMMIT MESSAGE**
`feat(inventory): update Inventory, Help and FAQ, Quotes, and Navigation`

**PUSHED AT**
2026-07-14T22:30:40.950Z

**WHAT CHANGED**
Update Inventory, Help and FAQ, Quotes, and Navigation.

**VERSION HISTORY DETAILS**
- Updated Inventory, Help and FAQ, Quotes, and Navigation, with changes to app screens, shared logic, automated tests, and documentation.
- Updated help and FAQ, with changes to documentation.
- Updated navigation across 1 changed file.
- Updated quotes, with changes to app screens.
...
**GIT COMMIT MESSAGE**
`feat(workshop-tasks): update Workshop Tasks, Maintenance, and Actions`

**PUSHED AT**
2026-06-23T15:39:33.306Z

**WHAT CHANGED**
Update Workshop Tasks, Maintenance, and Actions.
...
**PUSHED AT**
2026-06-19T08:59:10.774Z

**WHAT CHANGED**
Update database migrations, API routes, and 1 more areas.
...
**PUSHED AT**
2026-06-17T10:09:18.179Z

**WHAT CHANGED**
Update finalise commit summaries, maintenance workflow, and 2 more areas.
...
**WHAT CHANGED**
Update absence workflow, maintenance workflow, and 1 more areas.
...
**WHAT CHANGED**
Update sidebar navigation styling, mobile text size controls, and 3 more areas.
...
**WHAT CHANGED**
Update database migrations and automation scripts.
...
**WHAT CHANGED**
Update finalise commit summaries, inspection workflows, and 3 more areas.
...
**WHAT CHANGED**
Update maintenance workflow, inspection workflows, and 4 more areas.
...
**WHAT CHANGED**
Handle transient usage telemetry errors.
...
**WHAT CHANGED**
Update sidebar navigation styling, mobile text size controls, and 6 more areas.
...
**WHAT CHANGED**
Update finalise commit summaries, inspection workflows, and 2 more areas.
...
**WHAT CHANGED**
Update absence workflow, inspection workflows, and 4 more areas.
...
**WHAT CHANGED**
Update finalise commit summaries, maintenance workflow, and 3 more areas.
...
**WHAT CHANGED**
Update absence workflow, maintenance workflow, and 5 more areas.
...
**WHAT CHANGED**
Update absence workflow, timesheet workflow, and 4 more areas.
...
**WHAT CHANGED**
Update mobile text size controls, inspection workflows, and 4 more areas.
...
**GIT COMMIT MESSAGE**
`chore(release): initialise production release version tracking`

**WHAT CHANGED**
Added help page production version display, automatic version bumps on main branch pushes, and this private release log format.
