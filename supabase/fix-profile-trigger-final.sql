...
-- Sets role field based on role_id from roles table
-- Created: 2025-11-24
-- ========================================

-- Update the trigger function to always set role from roles table
...
BEGIN
  ...
  -- ALWAYS get the role name from the roles table
  -- This is required for the CHECK constraint
  ...
  -- Insert profile with both role_id and role (role is required by CHECK constraint)
  ...
  VALUES (
    ...
    final_role_id,
    role_name  -- This MUST match the CHECK constraint values
  )
