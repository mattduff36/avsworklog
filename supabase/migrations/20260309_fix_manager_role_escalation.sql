-- =============================================================================
-- Fix privilege-escalation: managers must not create or assign roles with
-- is_manager_admin = TRUE.
-- =============================================================================

BEGIN;

-- 1) Harden effective_can_assign_role: reject target roles that have
--    is_manager_admin = TRUE (not just check the name prefix).
...
-- 2) Harden roles INSERT policy: managers cannot set is_manager_admin = TRUE.
...
DO $$
BEGIN
  RAISE NOTICE 'Applied manager role-escalation fix (assignment + INSERT policy).';
END $$;
