...
Some modules contain sensitive company and customer information. If an admin has protected a module, SQUIRES asks for your sensitive access PIN after normal login before showing that module.
...
When you set, change, or reset the PIN, SQUIRES sends a verification email before the new PIN is activated.
