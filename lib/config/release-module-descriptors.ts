...
export const RELEASE_MODULE_DESCRIPTORS: ReleaseModuleDescriptor[] = [
  ...
  },
  {
    ...
    type: 'feat',
    category: 'standard',
    clientFacingName: MODULE_DISPLAY_NAMES['daily-allocation'],
    versionHistoryArea: 'Daily Allocation',
    subject: 'update daily allocation',
    priority: 43,
    patterns: [
      routePattern('app/(dashboard)/daily-allocation'),
      apiPattern('daily-allocation'),
      /daily[-_ ]allocation/iu,
    ],
    commitScopeAliases: ['daily-allocation', 'allocation'],
