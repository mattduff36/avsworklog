...
function SummaryTile({ label, value, helper, icon, accent = 'slate' }: SummaryTileProps) {
  const accentClass = {
    yellow: 'border-avs-yellow/25 bg-avs-yellow/10 text-avs-yellow',
            ...
            <div className="flex items-start justify-between gap-3">
              <div className="min-w-0">
                <div className="flex min-w-0 items-center gap-2">
                  <span className="truncate font-semibold text-white group-hover:text-avs-yellow">{item.reference}</span>
