...
import { canDeleteAbsenceRecord } from '@/lib/utils/absence-delete-guard';
  ...
  function canDeleteAbsence(absence: AbsenceWithRelations): boolean {
    return (
      ...
      canDeleteAbsenceRecord({
        date: absence.date,
        status: absence.status,
        isBankHoliday: absence.is_bank_holiday,
        autoGenerated: absence.auto_generated,
        bulkBatchId: absence.bulk_batch_id,
        recordSource: absence.record_source,
        hasEditScope: canEditAbsenceByScope(absence),
        isFullAccessAdmin: isAdminTier,
      })
    );
  }
                ...
                <div className="space-y-3">
                  ...
                  <div className="grid grid-cols-1 gap-2.5 md:grid-cols-2 xl:grid-cols-3">
                    {dayAbsences.map((event) => {
                      ...
                      const canDeleteTarget = target ? canDeleteAbsence(target) : false;
