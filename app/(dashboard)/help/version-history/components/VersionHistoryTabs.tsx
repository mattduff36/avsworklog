                  ...
                  >
                    <TableCell className="font-medium tabular-nums">
                      <button
                        ...
                        className="flex items-center gap-2 rounded-sm text-left focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-avs-yellow"
                        onClick={(event) => {
                        ...
                        <div className="grid gap-4 md:grid-cols-[minmax(0,1fr)_220px]">
                          <div className="space-y-2">
                            <div className="flex items-center gap-2 text-sm font-semibold text-foreground">
                              <FileText className="h-4 w-4 text-avs-yellow" />
                              More detail
                            </div>
                            <ul className="space-y-2 text-sm leading-6 text-muted-foreground">
                              {details.map((detail) => (
                                <li key={detail} className="flex gap-2">
                                  <span aria-hidden className="mt-2 h-1.5 w-1.5 shrink-0 rounded-full bg-avs-yellow" />
                                  <span>{detail}</span>
                                </li>
                              ))}
                            </ul>
