...
export async function GET(request: NextRequest) {
  try {
    ...
    const payload = await loadPlantReconciliation(workDate);
    ...
    await logServerError({
      ...
      request,
      componentName: '/api/daily-allocation/reconciliation',
      additionalData: { endpoint: 'GET /api/daily-allocation/reconciliation' },
    });
