...
const REQUIRED_COLUMNS: Record<string, string[]> = {
  ...
  inventory_hardware_items: ['id', 'name', 'name_normalized', 'is_active', 'sort_order'],
  inventory_hardware_balances: ['id', 'hardware_item_id', 'location_id', 'quantity', 'updated_by'],
  inventory_hardware_transaction_batches: ['id', 'operation_type', 'reason', 'note', 'created_by', 'created_at'],
  ...
  inventory_kiosk_config: ['id', 'kiosk_user_id', 'is_enabled', 'note', 'updated_at', 'updated_by'],
...
const REQUIRED_FKS: Array<{ table: string; column: string; referencesTable: string }> = [
  ...
  { table: 'inventory_hardware_balances', column: 'hardware_item_id', referencesTable: 'inventory_hardware_items' },
  { table: 'inventory_hardware_balances', column: 'location_id', referencesTable: 'inventory_locations' },
  { table: 'inventory_hardware_transaction_batches', column: 'created_by', referencesTable: 'profiles' },
  { table: 'inventory_hardware_transactions', column: 'batch_id', referencesTable: 'inventory_hardware_transaction_batches' },
  { table: 'inventory_hardware_transactions', column: 'hardware_item_id', referencesTable: 'inventory_hardware_items' },
  { table: 'inventory_hardware_transactions', column: 'location_id', referencesTable: 'inventory_locations' },
  { table: 'inventory_hardware_transactions', column: 'transfer_location_id', referencesTable: 'inventory_locations' },
  { table: 'inventory_kiosk_config', column: 'kiosk_user_id', referencesTable: 'profiles' },
  { table: 'inventory_kiosk_config', column: 'updated_by', referencesTable: 'profiles' },
  { table: 'inventory_kiosk_transfer_batches', column: 'yard_location_id', referencesTable: 'inventory_locations' },
  { table: 'inventory_kiosk_transfer_batches', column: 'counterpart_location_id', referencesTable: 'inventory_locations' },
  { table: 'inventory_kiosk_transfer_batches', column: 'movement_batch_id', referencesTable: 'inventory_item_movement_batches' },
  { table: 'inventory_kiosk_transfer_batches', column: 'hardware_batch_id', referencesTable: 'inventory_hardware_transaction_batches' },
  { table: 'inventory_kiosk_transfer_batches', column: 'created_by', referencesTable: 'profiles' },
