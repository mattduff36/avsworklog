...
export const LIVE_LEGACY_RECONCILIATION_REGISTRY: readonly LegacyReconciliationRegistryEntry[] = [
  ...
  {
    registryId: 'released:ws_238835cc7ae62abc',
    workstreamId: 'ws_238835cc7ae62abc',
    kind: 'released',
    trustedReleaseSha: '71e91f2b497fa100b98ef5f2d8ccf6e33c7df386',
    expectedPreviousPhase: 'initialized',
    expectedNextAction: 'run_preflight',
    expectedBaseCommit: 'a603b38bef0f4d8a4b710436c4683ad587631d14',
    expectedHeadCommit: '5f2d243e0f6740a647e8ff6f8859dd1b5f78bbfa',
    expectedCheckpointId: null,
    protocolPreimageSha256: '906541a5cabee7101e50765f90fb61eb8b35016038bd47a9f34052cb3090cd80',
    identityProof: {
      kind: 'plan-in-commit',
      implementationCommit: '9a778d8b20d6a6f2135a860ee1950c9ca0a0b0fa',
      planPath: 'plans/delete-user-remove-annual-leave.md',
    },
    reason:
      'Delete-user annual-leave cleanup already shipped; initialized protocol is leftover and did not complete finalise-start.',
  },
  {
    registryId: 'released:ws_84cb68b5830be523',
    workstreamId: 'ws_84cb68b5830be523',
    kind: 'released',
    trustedReleaseSha: '71e91f2b497fa100b98ef5f2d8ccf6e33c7df386',
    expectedPreviousPhase: 'initialized',
    expectedNextAction: 'run_preflight',
    expectedBaseCommit: '9db61f30681d11aa6ee6f3622bcb5d2c474ab244',
    expectedHeadCommit: '9db61f30681d11aa6ee6f3622bcb5d2c474ab244',
    expectedCheckpointId: null,
    protocolPreimageSha256: '9f58620f603f32b57d8c31376728c7f93761561779e1c347824e57503f55308e',
    identityProof: {
      kind: 'plan-in-commit',
      implementationCommit: '9a778d8b20d6a6f2135a860ee1950c9ca0a0b0fa',
      planPath: 'plans/delete-user-absence-guard-lock.md',
    },
    reason:
      'Delete-user absence-guard lock already shipped; initialized successor protocol is leftover and did not complete finalise-start.',
  },
  {
    registryId: 'released:ws_425d015b6a54acad',
    workstreamId: 'ws_425d015b6a54acad',
    kind: 'released',
    trustedReleaseSha: '71e91f2b497fa100b98ef5f2d8ccf6e33c7df386',
    expectedPreviousPhase: 'initialized',
    expectedNextAction: 'run_preflight',
    expectedBaseCommit: '1d7f5f9e0bb0baf361201183d815f1224156ce49',
    expectedHeadCommit: '1d7f5f9e0bb0baf361201183d815f1224156ce49',
    expectedCheckpointId: null,
    protocolPreimageSha256: '9308d86bd00c66099ba531af2923244f61fcc4f68a27c5973d15c3620f8c2471',
    identityProof: {
      kind: 'plan-in-commit',
      implementationCommit: '2fe6d07362928ec260b4f8520659ccc2ffd36bbf',
      planPath: 'plans/bank-holiday-self-override-trial.md',
    },
    reason:
      'Bank-holiday self-override trial already shipped; initialized protocol is leftover and did not complete finalise-start.',
  },
  {
    registryId: 'released:ws_fa784f334690ffeb',
    ...
    expectedNextAction: 'run_preflight',
    expectedBaseCommit: 'a603b38bef0f4d8a4b710436c4683ad587631d14',
    expectedHeadCommit: 'a603b38bef0f4d8a4b710436c4683ad587631d14',
    expectedCheckpointId: null,
    protocolPreimageSha256: 'cc547fe9b9bbc673024f8fe516594ba5f6e9de2f03bc9652c1e3ac0b11fbb222',
    identityProof: {
      kind: 'plan-in-commit',
      implementationCommit: '1d7f5f9e0bb0baf361201183d815f1224156ce49',
      planPath: 'plans/timesheet-payroll-snapshot-recalc.md',
    },
    reason:
      'Timesheet payroll snapshot recalculation already shipped; initialized protocol is leftover and did not complete finalise-start.',
  },
  {
